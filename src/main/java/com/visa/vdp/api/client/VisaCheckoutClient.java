...
public class VisaCheckoutClient extends AbstractClient{
    ...
    public static void main(String args[]) throws Exception {
         ...
         xPayToken = XPayTokenGeneration.getXPayToken(GET_PAYMENT_DATA, XPayTokenGeneration.API_KEY, XPayTokenGeneration.SHARED_SECRET) ;
         ...
         xPayToken = XPayTokenGeneration.getXPayToken(UPDATE_PAYMENT_INFO, API_KEY, SHARED_SECRET) ;
